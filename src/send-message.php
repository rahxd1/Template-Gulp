...
if(isset($_POST['submit'])){
    ...
    $html = '<table width="600px" border="0" style="font-size:15px;text-align:center;border-collapse:collapse"> <thead> <tr> <td style="background-color:#00afdb" height="60px"></td> <td></td> </tr> <tr> <td style="font-size:25px;color:#fff;background-color:#00afdb">Alberta</td> <td rowspan="2" style="text-align:center;font-size:20px;color:#fff;background-color:#00afdb"> '.$subject.' </td> </tr> <tr> <td style="font-size:25px;color:#fff;background-color:#00afdb"></td> </tr> <tr> <td style="background-color:#00afdb" height="30px"></td> <td></td> </tr> </thead><tbody style="text-align:left"> <tr> <td colspan="2" height="30px"></td> </tr> <tr> <td colspan="2" style="text-align:center">Nombre:</td> </tr> <tr style="font-size:16px;text-align:center;font-weight:bold"> <td colspan="2">'.$subject.'</td> </tr> <tr> <td colspan="2" height="50px"></td> </tr> <tr> <td style="padding-left:60px">Email:</td> <td style="padding-left:50px">Ciudad:</td> </tr> <tr style="font-size:16px;font-weight:bold"> <td style="padding-left:60px">'.$from.'</td> <td style="padding-left:50px">'.$city.'</td> </tr> <tr> <td colspan="2" height="30px"></td> </tr> <tr> <td colspan="2" style="text-align:center"><h2>¿Qué te interesa estudiar en Alberta?</h2></td> </tr> <tr> <td colspan="2" style="text-align:left">'.$comment.'</td> </tr>';
